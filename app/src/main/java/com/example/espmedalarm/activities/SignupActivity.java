...
/**
 * Account creation form. On success, the new Firebase user is signed in
 * automatically, so we go straight to MainActivity.
 */
    ...
    private void attemptSignup() {
        ...
        auth.createUserWithEmailAndPassword(email, password)
                .addOnSuccessListener(result -> {
                    ...
                    if (user != null) {
                        userRepository.recordSignup(user.getUid(),
